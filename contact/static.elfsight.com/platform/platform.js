...
! function(e) {
    ...
    var i = n(6),
        ...
        l = function e(t, n, l) {
            var p, u, f, d, g = t & e.F,
                ...
                x = y[c] || (y[c] = {});
            h && (l = n);
            for (p in l) u = !g && w && void 0 !== w[p], f = (u ? w : l)[p], d = m && u ? s(f, i) : b && "function" == typeof f ? s(Function.call, f) : f, w && a(w, p, f, t & e.U), y[p] != f && r(y, p, d), b && x[p] != f && (x[p] = f)
        };
    ...
    e.exports = function(e, t) {
        ...
        return function(t, s, g) {
            for (var h, v, b = r(t), m = o(b), w = i(s, g, 3), y = a(m.length), x = 0, C = n ? d(t, y) : c ? d(t, 0) : void 0; y > x; x++)
    ...
    var i = n(53),
        ...
        g = function(e, t, n) {
            ...
            h.initialize = function() {
                h.logError = r.withModule(s), i(function() {
                    t = t || e.document.body, h.establishPreconnections(), h.observe(), h.collectWidgets(t), h.boot(), h.watchWidgetReset()
                })
            }, h.establishPreconnections = function() {
                h.preconnect(h.getPlatformUrl()), h.preconnect("https://static.elfsight.com"), h.preconnect("https://service-reviews-ultimate.elfsight.com"), h.preconnect("https://storage.elfsight.com")
                ...
                "string" != typeof e && h.logError("Widget Public ID required and should be a string", {
                    pid: e
                ...
                return "div" === e.tagName.toLowerCase() ? h.getEappsClass(e).replace("elfsight-app-", "") : e.getAttribute("data-id")
                ...
                h.getWidgetsElements(e).forEach(function(e) {
                    ...
                    if (t) {
                        ...
                        n === c ? h.requireWidget(t) : h.bootWidgetDeferredly(e, t, n), h.addPlaceholder(e)
                    }
                })
                ...
                window.addEventListener("message", function(e) {
                    var t = e.data;
                    t.action && "EappsPlatform.widgetReset" === t.action && h.resetWidget(t.widgetId)
                })
                ...
                h.getWidgetsElements().forEach(function(n) {
                    h.getWidgetIdByElement(n) === e && (delete v[e], n.parentNode.replaceChild(t(e), n))
                })
            }, h.initWidget = function(e) {
                var t = h.getWidgetIdByElement(e),
                    i = v[t];
                if (i) {
                    if (!i.status || !i.data) return void h.logError('Widget "' + t + '" can`t be initialized because ' + i.reason, e);
                ...
                if (n.length) {
                    ...
                    i.open("get", r + "?" + a), i.withCredentials = !0, i.onload = function() {
                        ...
                        t.status || h.logError("Boot failed because " + t.reason, t.data), v = Object.assign({}, v, t.data.widgets), h.loadAssets(t.data.assets), m.forEach(h.initWidget.bind(h)), e && e()
                    }, i.send()
                }
            }, h.getPage = function() {
                try {
                ...
                return e.eappsCustomPlatformUrl ? e.eappsCustomPlatformUrl : h.useServiceCore() ? "https://core.service.elfsight.com" : "https://apps.elfsight.com"
                ...
                t && t.length && t.filter(function(e) {
                    ...
                    n.src = t, n.setAttribute("defer", "defer"), n.setAttribute("charset", "UTF-8"), e.document.head.appendChild(n), w.push(t)
                })
            }, h.observe = function() {
                if (e.MutationObserver && !g) {
                    ...
                    g = new MutationObserver(function(e) {
                        var t = function(e) {
                            h.requireWidget(h.getWidgetIdByElement(e)), h.addPlaceholder(e)
                        };
                        e.forEach(function(e) {
                            var i = function(e) {
